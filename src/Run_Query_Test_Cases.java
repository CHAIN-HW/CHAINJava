...
public class Run_Query_Test_Cases {
	...
	public static void beforeAll(){
		...
		System.out.println("\nThe results from these tests can be found in outputs/tests/Run_Queries_Test.txt\n");
	...
	@Test
	public void test214(){
		System.out.println("\nRunning test 2.14 - dbpedia query");
		...
		fOut.write("Test 2.14 - dbpedia query\n");
		fOut.write("Trying to run query: \n\n" + current.getQuery());
	...
	@Test
	public void test215(){
		System.out.println("\nRunning test 2.15 - dbpedia query");
		...
		fOut.write("Test 2.15 - dbpedia query\n");
		fOut.write("Trying to run query: \n\n" + current.getQuery());
