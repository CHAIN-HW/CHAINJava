...
%JAVACMD% %JAVA_OPTS% -Xmx512M -classpath %CLASSPATH% -Dapp.name="d-tool" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" it.unitn.disi.annotation.DatasetTool %CMD_LINE_ARGS%
