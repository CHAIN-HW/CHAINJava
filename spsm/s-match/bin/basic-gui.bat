...
%JAVACMD% %JAVA_OPTS% -Xmx512M -classpath %CLASSPATH% -Dapp.name="basic-gui" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" it.unitn.disi.smatch.gui.MatchingBasicGUI %CMD_LINE_ARGS%
