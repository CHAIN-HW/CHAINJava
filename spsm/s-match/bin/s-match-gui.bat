...
%JAVACMD% %JAVA_OPTS% -Xmx512M -classpath %CLASSPATH% -Dapp.name="s-match-gui" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" it.unitn.disi.smatch.gui.SMatchGUI %CMD_LINE_ARGS%
